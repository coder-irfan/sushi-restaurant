  ...
  return (
    <>
      <header className="relative">
        <div
          className={`font-cormorantSC 2xl:max-w-[100rem] mx-auto px-4 sm:px-6 md:px-8 py-3 md:py-4 lg:px-16 fixed top-0 right-0 left-0 z-[60]
        ...
        >
          ...
          <div
            className={`fixed w-screen h-screen inset-0 bg-black opacity-70 transition-all duration-700 z-[80]
          ...
          <div className="flex md:items-center justify-between">
            ...
            <div className="z-50">
              <nav
                className={`md:relative fixed top-0 right-0 h-full w-2/3 sm:w-2/4 md:right-0 transition-all duration-700 pt-24 pr-6 md:pr-0 md:pt-0
              ...
              >
                <div className="flex flex-col md:flex-row items-end gap-10">
                  ...
                  <Link to="/reservation">
                    <button
                      className="flex md:hidden uppercase text-goldYellow border-2 border-goldYellow px-3 py-1 shadow-[0_0_0.3rem] lg:text-lg xl:text-xl hover:text-softBeigeYellow
                ...
                {isOpen && (
                  <div
                    className="absolute top-7 right-5 sm:right-6 text-2xl md:hidden"
                    onClick={() => setIsOpen(false)}
                  >
                    <FaTimes
                      aria-label="Close menu"
                      className="text-goldYellow cursor-pointer"
                    />
                  </div>
                )}
              </nav>
            ...
            <div
              className={`flex items-center justify-center gap-4 lg:gap-6
                ${isAuthenticated && user ? "" : "mr-10 md:mr-0"}
              `}
            >
              ...
              {isAuthenticated && user ? (
                <>
                  <div className="font-cinzel" ref={menuRef}>
                    <FaUser
                    ...
                    {isUserOpen && (
                      <div className="absolute right-10 mt-6  bg-deepGray shadow-xl shadow-darkCharcoal rounded-lg z-10">
                        ...
                        <button
                          className="flex items-center gap-6 p-4 hover:text-softBeigeYellow transition-colors duration-300"
                          onClick={logout}
                        >
                          Log out
                ...
                <Link to="/reservation">
                  <button
                    className="hidden md:flex uppercase text-goldYellow border-2 border-goldYellow px-3 py-1 shadow-[0_0_0.3rem] lg:text-lg xl:text-xl hover:text-softBeigeYellow
                    hover:border-softBeigeYellow transition-colors duration-300 font-semibold items-center gap-2"
                  >
                    <FaRegCalendarAlt />
                    Reservation -----
